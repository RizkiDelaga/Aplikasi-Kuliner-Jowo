...
class DetailResepActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //  Inisialisasi ID yang ada pada file activity_detail_resep.xml
        ...
        //  Memasukan data object kedalam id pada masing-masing widget
        ...
        // Menambahkan Title Action Bar
        supportActionBar?.title = "Detail Resep " + resep.namaMasakan
        ...
        //  Pindah activity dengan membawa Intent ID Video Youtube untuk menampilkan Video Fullscreen
