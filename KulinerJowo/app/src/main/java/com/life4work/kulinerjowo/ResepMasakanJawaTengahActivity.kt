...
class ResepMasakanJawaTengahActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_resep_masakan_jawa_tengah)
        ...
        recyclerView.adapter = ResepAdapter(this, KumpulanResep.resepMasakanJateng){
